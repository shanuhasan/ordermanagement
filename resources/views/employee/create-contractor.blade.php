@extends('layouts.app')
@section('title', 'New Contractor / Thekedar')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Contractor / Thekedar</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('employee.contractor') }}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
            ...
            <form action="" id="userForm" method="post">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('employee.contractor') }}" class="btn btn-info">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
...
@section('script')
    <script>
        $('#userForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('employee.store.contractor') }}",
                type: 'post',

@extends('layouts.app')
@section('title', 'Contractor Orders')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-md-12 text-right">
                    <a href="{{ route('contractor.order.amount', $employee->guid) }}" class="btn btn-warning">Advance
                        Amount</a>
                    <a href="{{ route('contractor.order.receivedPiece', $employee->guid) }}" class="btn btn-success">Received
                        Piece
                        History</a>
                    <a href="{{ route('contractor.order.payment.history', $employee->guid) }}"
                        class="btn btn-secondary">Payment
                        History</a>
                    <a href="{{ route('contractor.order.print', $employee->guid) }}" class="btn btn-info">Print</a>
                    <a href="{{ route('contractor.order.create', $employee->guid) }}" class="btn btn-primary">Add</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->

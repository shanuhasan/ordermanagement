        ...
        <div class="container-fluid">
            <form action="" id="companyForm" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" value="{{ $company->slug }}" readonly
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option {{ $company->status == 0 ? 'selected' : '' }} value="0">Block</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                @if (!empty($company->image))
                                    <div>
                                        <img width="200" src="{{ asset('uploads/company/' . $company->image) }}"
                                            alt="">
                                    </div>
                                @endif
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('admin.company.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
...
@section('script')
    <script>
        $('#companyForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.company.update', $company->guid) }}",
                type: 'put',
